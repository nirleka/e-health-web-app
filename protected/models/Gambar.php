...
class Gambar extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('file, deskripsi, id_penyakit', 'required'),
			array('file', 'length', 'max'=>60),
			array('id_penyakit', 'length', 'max'=>20),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, file, deskripsi, id_penyakit', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('id_penyakit',$this->id_penyakit,true);
